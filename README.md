...
**答案：声明式**。你描述"想要什么"，Terraform 决定"怎么做"。
</details>
...
| 审核轮次 | 审核人 | 发现问题 | 状态 |
|---------|-------|---------|------|
| 第 1 轮 | 🔍 技术审核（资深 Terraform 专家） | 6 个严重错误 + 4 个警告 | ✅ 全部修复 |
| 第 2 轮 | 🎓 学生视角（零基础模拟） | 3 个核心建议 | ✅ 全部采纳 |
